...
def run_example():
    ...
    mo_command = f'mo --saved_model_dir {saved_model_dir} ' \
                 f'--model_name {model_name} --input_shape [1, 244, 244, 3]' \
    ...
    print(f'The original model accuracy@top1: {results[1]:.3f}')
    ...
    print(f'The quantized model accuracy@top1: {quantized_results[0]:.3f}')
